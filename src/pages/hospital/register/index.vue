    ...
    <div class="register">
        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="time">
                    放号时间：{{hospitailStore.hospitalInfo.bookingRule?.releaseTime }}，挂停时间：{{  hospitailStore.hospitalInfo.bookingRule?.stopTime }}
                </div>
                <div class="address">
